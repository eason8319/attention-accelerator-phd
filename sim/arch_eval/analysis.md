...
python sim/arch_eval/roofline.py
python sim/arch_eval/scale-sim/run_scalesim.py
python sim/arch_eval/timeloop/run_timeloop.py   # 需 Docker 镜像
python sim/arch_eval/collect_results.py
```
