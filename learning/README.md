...
> **定位：R0 技能建设。当前状态见 [研究里程碑](../docs/progress/milestones.md)。**
...
配套能力清单见研究计划「所需能力」；每个实验目录保留源码、results/、REPORT.md 和 experiment.json。

## 总览

| 项目 | 主题 | 历史映射（已废止为主线定义） | 目录 |
| --- | --- | --- | --- |
| P1 | Attention 数值内核复现 | 原「主线1」算法侧 | [p1_attention_numerics/](p1_attention_numerics/) |
| P2 | 低精度量化实验（**proxy KV**） | 原「主线2」 | [p2_quantization/](p2_quantization/) |
| P3 | 架构评估工具链 | 原阶段1 baseline | [p3_arch_eval/](p3_arch_eval/) |
| P4 | RTL 关键模块（缺完整 $PV$） | 原「主线1/3」 | [p4_rtl/](p4_rtl/) |
| P5 | tile-level 模拟器（未建模压缩 KV） | 原「主线4」 | [p5_tile_sim/](p5_tile_sim/) |
